...
#ifndef DEVTOOLS_GOMA_LIB_CLANG_TIDY_EXECREQ_NORMALIZER_H_
#define DEVTOOLS_GOMA_LIB_CLANG_TIDY_EXECREQ_NORMALIZER_H_
...
#endif  // DEVTOOLS_GOMA_LIB_CLANG_TIDY_EXECREQ_NORMALIZER_H_
