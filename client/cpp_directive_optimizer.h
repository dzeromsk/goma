...
#ifndef DEVTOOLS_GOMA_CLIENT_CPP_DIRECTIVE_OPTIMIZER_H_
#define DEVTOOLS_GOMA_CLIENT_CPP_DIRECTIVE_OPTIMIZER_H_
...
#endif  // DEVTOOLS_GOMA_CLIENT_CPP_DIRECTIVE_OPTIMIZER_H_
