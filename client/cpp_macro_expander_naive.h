...
#ifndef DEVTOOLS_GOMA_CLIENT_CPP_MACRO_EXPANDER_NAIVE_H_
#define DEVTOOLS_GOMA_CLIENT_CPP_MACRO_EXPANDER_NAIVE_H_
...
#endif  // DEVTOOLS_GOMA_CLIENT_CPP_MACRO_EXPANDER_NAIVE_H_
